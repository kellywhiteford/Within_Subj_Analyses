...
for s = 1:size(subj,2) % for each subject
    ...
    EEG = pop_select( EEG,'nochannel',{'EXG1','EXG2','EXG3' 'EXG4' 'EXG5' 'EXG6' 'EXG7' 'EXG8' 'GSR1','GSR2','Erg1','Erg2','Resp','Plet','Temp'}); % Remove references and unused channels
    ...
    % Quality-control check for BU data
